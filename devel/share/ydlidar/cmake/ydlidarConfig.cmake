...
if("TRUE" STREQUAL "TRUE")
  set(ydlidar_SOURCE_PREFIX /home/eaibot/dashgo_ws/src/dashgo/ydlidar_v1.3.1)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ydlidar' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/eaibot/dashgo_ws/src/dashgo/ydlidar_v1.3.1/${idir}'.  ${_report}")
    endif()
